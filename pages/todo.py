...
with st.container():
    ...
    with col1:  
        if st.button("▶"):
            ...
            if all_agro_data:
                df_agro = pd.DataFrame(all_agro_data, columns=['Tienda','Categoria','Corte','Nombre Pagina','Precio x KG(neto)','precio pagina'])
            ...
            # if all_apunto_data:
            #     df_apunto = pd.DataFrame(all_apunto_data, columns=['Tienda','Categoria','Corte','Nombre Pagina','Precio x KG(neto)','precio pagina'])
            ...
            #     progress_bar.progress((i + 1) / total_urls)
            #     status_text.text(f"carnes nubles en proceso... ({i + 1}/{total_urls})")
            ...
            # if all_nubles_data:
            #     df_nubles = pd.DataFrame(all_nubles_data, columns=['Tienda','Categoria','Corte','Nombre Pagina','Precio x KG(neto)','precio pagina'])
            ...
            #     progress_bar.progress((i + 1) / total_urls)
            #     status_text.text(f"Doña Carne en proceso... ({i + 1}/{total_urls})")
                    
            # status_text.text(f"Operación completada en doña carne")
            # progress_bar.progress(1.0)     
            
            # # Procesar DataFrame de dona carne
            # if all_donacarne_data:
            #     df_donacarne = pd.DataFrame(all_donacarne_data,columns=['Tienda','Categoria','Corte','Nombre Pagina','Precio x KG(neto)','precio pagina'])
            ...
            #     progress_bar.progress((i + 1) / total_urls)
            #     status_text.text(f"El Carnicero en proceso... ({i + 1}/{total_urls})")
            ...
            #     df_carnicero = pd.DataFrame(all_carnicero_data,columns=['Tienda','Categoria','Corte','Nombre Pagina','Precio x KG(neto)','precio pagina'])
            ...
            #     progress_bar.progress((i + 1) / total_urls)
            #     status_text.text(f"Frigorifico en proceso... ({i + 1}/{total_urls})")
            ...
            #     df_frigorifico = pd.DataFrame(all_frigorifico_data,columns=['Tienda','Categoria','Corte','Nombre Pagina','Precio x KG(neto)','precio pagina'])
            ...
            #     progress_bar.progress((i + 1) / total_urls)
            #     status_text.text(f"Procarne en proceso... ({i + 1}/{total_urls})")
            ...
            #     df_procarne = pd.DataFrame(all_procarne_data,columns=['Tienda','Categoria','Corte','Nombre Pagina','Precio x KG(neto)','precio pagina'])
